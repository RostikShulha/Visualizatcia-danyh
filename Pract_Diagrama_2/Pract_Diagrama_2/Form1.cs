    ...
    public partial class Form1 : Form
    {
        ...
        private void btGenerate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (m > 10)
                { MessageBox.Show("Кількість категорій витрат перебільшує число 10", "Помилка"); }
                else
                {
        ...
        private void btCreateDiag_Click(object sender, EventArgs e)
        {
            ...
            for (int j = 0; j < m; j++)
            {
                ...
                Sum += A[j];
                if (A[j] <= 0)
                { MessageBox.Show("Серед наведених елементів присутні " + "від'ємні або нульові", "Помилка"); }
            }

            if (Sum != 100)
            { MessageBox.Show("Сума відсоткового утримання витрат " + "повинна бути рівна 100%. Будь ласка, перевірте дані ще раз", "Помилка"); }
            else
            {
